...
{
    public partial class comptabilité_pratique9mois : Form
    {
        public comptabilité_pratique9mois()
        {
            InitializeComponent();
        }
...
new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Bureatique3Mois;Integrated Security=True;Pooling=False");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM Bureatique_9Mois", con);
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("DELETE Bureatique_9Mois WHERE Id=@Id", con);
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM Bureatique_9Mois WHERE Nom=@Nom", con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Bureatique_9Mois VALUES (@Prénom,@Nom,@Date_De_Naissance,@date_de_linscription,@Telephone,@Le_Group,@Niveau_Scolaire)", con);
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("UPDATE Bureatique_9Mois SET Prénom=@Prénom,Nom=@Nom,Date_De_Naissance=@Date_De_Naissance,date_de_linscription=@date_de_linscription,Telephone=@Telephone,Le_Group=@Le_Group,Niveau_Scolaire=@Niveau_Scolaire WHERE Id=@Id", con);

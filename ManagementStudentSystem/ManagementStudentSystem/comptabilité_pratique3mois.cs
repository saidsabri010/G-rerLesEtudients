...
{
    public partial class comptabilité_pratique3mois : Form
    {
        public comptabilité_pratique3mois()
        {
            InitializeComponent();
        }
...
new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Bureatique3Mois;Integrated Security=True;Pooling=False");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Bureatique_3Mois VALUES (@Prénom,@Nom,@Date_De_Naissance,@date_de_linscription,@Telephone,@Le_Group,@Niveau_Scolaire)", con);
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("UPDATE Bureatique_3Mois SET Prénom=@Prénom,Nom=@Nom,Date_De_Naissance=@Date_De_Naissance,date_de_linscription=@date_de_linscription,Telephone=@Telephone,Le_Group=@Le_Group,Niveau_Scolaire=@Niveau_Scolaire WHERE Id=@Id", con);

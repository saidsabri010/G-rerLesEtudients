...
{
    public partial class Informatique : Form
    {
        public Informatique()
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("select CIN from Informatique where CIN= @CIN", con);
                ...
                else
                {
                    ...
                    SqlCommand cmde = new SqlCommand("INSERT INTO Informatique VALUES (@CIN,@Prénom,@Nom,@Date_De_Naissance,@Tél,@Adresse,@date_de_linscription,@Durée_De_Formation,@Groupe,@Niveau_Scolaire)", con);
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM Informatique", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    SqlCommand cmde = new SqlCommand("DELETE Informatique WHERE CIN=@CIN", con);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmde = new SqlCommand("SELECT * FROM Informatique WHERE CIN=@CIN", con);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (comboBox5.Text == "")
                {
                    SqlCommand cmde = new SqlCommand("SELECT * FROM Informatique WHERE Durée_De_Formation=@Durée_De_Formation", con);
                ...
                if (comboBox4.Text == "")
                {
                    SqlCommand cmde = new SqlCommand("SELECT * FROM Informatique WHERE Groupe=@Groupe", con);
                ...
                if ((comboBox4.Text != "" && comboBox5.Text != ""))
                {
                    ...
                    {
                        SqlCommand cmde = new SqlCommand("SELECT * FROM Informatique WHERE Groupe=@Groupe and Durée_De_Formation=@Durée_De_Formation", con);

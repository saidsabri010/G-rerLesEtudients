...
{
    public partial class Design_graphique : Form
    {
        public Design_graphique()
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("select CIN from Design_graphique where CIN= @CIN", con);
                ...
                else
                {
                    ...
                    SqlCommand cmde = new SqlCommand("INSERT INTO Design_graphique VALUES (@CIN,@Prénom,@Nom,@Date_De_Naissance,@Tél,@Adresse,@date_de_linscription,@Durée_De_Formation,@Groupe,@Niveau_Scolaire)", con);
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    SqlCommand cmde = new SqlCommand("UPDATE Design_graphique SET CIN=@CIN,Prénom=@Prénom,Nom=@Nom,Date_De_Naissance=@Date_De_Naissance,Tél=@Tél,Adresse=@Adresse,date_de_linscription=@date_de_linscription,Durée_De_Formation=@Durée_De_Formation,Groupe=@Groupe,Niveau_Scolaire=@Niveau_Scolaire WHERE CIN=@CIN", con);
                    cmde.Parameters.AddWithValue("@Prénom", textBox1.Text);
                    cmde.Parameters.AddWithValue("@Nom", textBox2.Text);
                    cmde.Parameters.AddWithValue("@Date_De_Naissance", SqlDbType.Date).Value = dateTimePicker1.Value.Date;
                    cmde.Parameters.AddWithValue("@date_de_linscription", SqlDbType.Date).Value = dateTimePicker2.Value.Date;
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM Design_graphique", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    SqlCommand cmde = new SqlCommand("DELETE Design_graphique WHERE CIN=@CIN", con);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmde = new SqlCommand("SELECT * FROM Design_graphique WHERE CIN=@CIN", con);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (comboBox5.Text == "")
                {
                    SqlCommand cmde = new SqlCommand("SELECT * FROM Design_graphique WHERE Durée_De_Formation=@Durée_De_Formation", con);
                ...
                if (comboBox4.Text == "")
                {
                    SqlCommand cmde = new SqlCommand("SELECT * FROM Design_graphique WHERE Groupe=@Groupe", con);
                ...
                if ((comboBox4.Text != "" && comboBox5.Text != ""))
                {
                    ...
                    {
                        SqlCommand cmde = new SqlCommand("SELECT * FROM Design_graphique WHERE Groupe=@Groupe and Durée_De_Formation=@Durée_De_Formation", con);
